export const Footer = () => {
    return <div className="flex flex-col justify-center items-center space-y-2">
        <div className="text-white text-xl text-center felx justify-center ">
            Contact Us
        </div>
        ...
        <div className="mt-4 border-t border-gray-200 pt-4 text-center">
            <p className="text-base text-gray-400 xl:text-center mb-4">&copy; 2020 Workflow, Inc. All rights reserved.</p>
        </div>
    </div>
}